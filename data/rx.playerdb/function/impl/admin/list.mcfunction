...
execute if data storage rx:temp playerdb.uuid run tellraw @s ["", {text:"<<", color: "#720026", "bold": true, click_event:{action: "run_command", command: "/trigger rx.pdb.LT set -1"}, hover_event: {action: "show_text", "value":{text:"Click to navigate",color:"#DAD6D6"}}}, " ", {text: "Player UID List", color:"#CE4257"}, " ", {text:">>", color: "#720026", "bold": true, hover_event: {action: "show_text", "value":{text:"Click to navigate",color:"#DAD6D6"}}, click_event:{action: "run_command", command: "/trigger rx.pdb.LT set 1"}}]
